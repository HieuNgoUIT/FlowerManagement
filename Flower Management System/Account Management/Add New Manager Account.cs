...
{
    public partial class Add_New_Manager_Account : Form
    {
        public Add_New_Manager_Account()
        {
            InitializeComponent();
        }

        private void Add_New_Manager_Account_Load(object sender, EventArgs e)
        {
            Add_New_Manager_Account_Form_Setting();
            Button_Setting();
            TextBox_Setting();
        }
        // -------------------------------------------------------------------------
        ...
        private void BT_Set_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (A.Check_Exist_Value(check_username) == false)
                {
                    string add_query = "insert into Account (Employee_ID, Username, Password) values"
                                                                  + " ('" + LB_ID.Text + "'"
                                                                  + ", '" + TB_Username.Text + "'"
                                                                  + ", '" + TB_Password.Text + "')";
